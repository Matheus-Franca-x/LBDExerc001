...
<div class="bg-black custom">
	<div class="container bg-white scroll" id="nav-container">
		<h1 class="text-center">CRUD - Curso</h1>
		...
		<main class="rounded-4 border border-primary form-container m-auto mb-3">
			<form action="curso" method="post">
				<div class="form-floating d-flex mb-3">
					<input type="number" class="form-control input-height" id="floatingInput" placeholder="Codigo" step="1" name="codigoCurso" value='<c:out value="${curso.codigo}"></c:out>'>
				...
				<div class="form-floating mb-3">
					<input type="text" class="form-control input-height" id="floatingInput" placeholder="Nome" name="nomeCurso" value='<c:out value="${curso.nome}"></c:out>'>
					<label for="floatingInput" class="font-text">Nome</label>
				</div>
				<div class="form-floating mb-3 input-height">
					<input type="text" class="form-control input-height" id="floatingInput" placeholder="Area" step="1" name="areaCurso" value='<c:out value="${curso.area}"></c:out>'>
					<label for="floatingInput" class="font-text">Área</label>
				</div>
				<div class="d-flex">
