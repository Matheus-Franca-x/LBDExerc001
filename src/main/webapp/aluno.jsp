...
<div class="bg-black custom">
	<div class="container bg-white scroll" id="nav-container">
		<h1 class="text-center">CRUD - Aluno</h1>
		...
		<main class="rounded-4 border border-primary form-container m-auto mb-3">
			<form action="aluno" method="post">
				<div class="form-floating d-flex mb-3">
					<input type="number" class="form-control input-height" id="floatingInput" placeholder="Ra" step="1" name="raAluno" value='<c:out value="${aluno.ra}"></c:out>'>
				...
				<div class="form-floating mb-3">
					<input type="text" class="form-control input-height" id="floatingInput" placeholder="Nome"name="nomeAluno" value='<c:out value="${aluno.nome}"></c:out>'>
					<label for="floatingInput" class="font-text">Nome</label>
				</div>
				<div class="form-floating mb-3 input-height">
					<input type="number" class="form-control input-height" id="floatingInput" placeholder="Area" step="1" name="idadeAluno" value='<c:out value="${aluno.idade}"></c:out>'>
					<label for="floatingInput" class="font-text">Idade</label>
				</div>
				<div class="d-flex">
			...
			<table class="table table-striped">
				...
				<tbody>
					<c:if test="${not empty alunos}">
						<c:forEach var="c" items="${alunos}">
							<tr>
								<th scope="row"><c:out value="${c.ra}"/></th>
								<td><c:out value="${c.nome}"/></td>
								<td><c:out value="${c.idade}"/></td>
							</tr>
						</c:forEach>
					</c:if>
				</tbody>
